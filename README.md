...
* **Automatic Targeting:** Generates precise alert text with target event number, day, time, and turnaround window (including overnight re-rig flags):
  * **Hawkins:** Re-rig from `4X-` to `4-` after Event 38 (12:20) for Event 65 (15:10), then an **overnight re-rig** back to `4X-` for Sunday Event 78 (08:30).
  * **Makaro:** Re-rig from `2X` to `2-` after Event 73 (08:48) for Event 90 (10:26), then re-rig back to `2X` for Event 101 (11:43).
